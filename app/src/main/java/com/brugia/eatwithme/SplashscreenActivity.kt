...
import com.brugia.eatwithme.skew.SkewTextView
...
class SplashscreenActivity : AppCompatActivity() {
    private lateinit var fullscreenContent: SkewTextView
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fullscreenContent = findViewById(R.id.textViewLogoLauncher)
